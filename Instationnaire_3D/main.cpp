...
{ 
  ...
  // cette boucle pour chaque instant enregistre la solution 
  for(int k = 0; k < M_s.getN(); k++)
  {
    ...
    {
      std::cerr << "Erreur lors de l'ouverture du fichier fichier_vtk.\n";
    }
  }

  // pour exécution de ce programme il faut ajouter -std=c++17 à cause de cette fonction std::filesystem;
  return 0;
}